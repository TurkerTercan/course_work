/**
 * BinarySearchTree class from my book
 * @param <E> generic that extends Comparable interface
 */
public class BinarySearchTree<E extends Comparable<E>> extends BinaryTree<E>
     ...
     * @param target the object that is searched
     * @return true if tree contains the target; otherwise, false
     */
    @Override
     ...
     * @param target the object that is searched
     * @return if localRoot is null returns false, if localRoot.data equals target returns true
     */
     ...
     * @return The object deleted from the tree or null if the object
     *         was not in the tree
    ...
    /**
     * Find the node that is the inorder predecessor and replace it with
     * its left child (if any)
